...
exports.handler = async function (event) {
  ...
  const systemInstruction =
    ...
    `Тон: Професійний, підтримуючий, академічний, але зрозумілий.\n` +
    `КРИТИЧНО ВАЖЛИВО про формат математики: НІКОЛИ не використовуй LaTeX і символи долара ($). Чат не вміє показувати LaTeX. Пиши формули простим текстом: степінь як x^2 або x², дріб як a/b (наприклад 3/4, 8/27), мішане число як "1 1/2", множення як ·. Інтерфейс сам перетворить a/b на гарний двоповерховий дріб. Наприклад, пиши "a^n" та "1/4", а НЕ "$a^n$" чи "$\\frac{1}{4}$". Будь-який символ $ у відповіді — це помилка.\n\n` +
